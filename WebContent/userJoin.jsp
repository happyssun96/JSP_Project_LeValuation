...
<section class="container mt-3" style="max-width : 560px;">
	<form method="post" action="./userRegisterAction.jsp" name="registerForm">
	...
	<a href="?language=en">English</a> <br>
		...
		<div class="form-group">
			<label><fmt:message key="userEmail" /></label>
			<input type="email" name="userEmail" class="form-control">
		</div>
		<input name="registerButton" value="<fmt:message key="registerButton" />" type="submit" class="btn btn-primary" onclick="checkForm()">
	</form>
</section>
